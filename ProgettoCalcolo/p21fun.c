...
// Ritorna il numero di cifre di un intero (es: num=666, return=3)
...
// Alloca dinamicamente una matrice (ALLOCA DINAMICAMENTE NON INIZIALIZZA!!! STUDIATEVI LA DIFFERENZA)
...
// Funzione di debug che compara due matrici. Non studiare
